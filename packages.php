							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-md btn-outline-success edit_package" type="button" data-id="<?php echo $row['id'] ?>" data-package="<?php echo $row['package'] ?>" data-description="<?php echo $row['description'] ?>" data-amount="<?php echo $row['amount'] ?>" data-img="<?php echo $row['img'] ?>" >Edit</button>
										<button class="btn btn-md btn-outline-danger delete_package" type="button" data-id="<?php echo $row['id'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
